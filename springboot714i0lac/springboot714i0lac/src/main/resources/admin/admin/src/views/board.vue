<template>
	<div class="content" :style='{"alignContent":"flex-start","minHeight":"100vh","overflow":"hidden","flexWrap":"wrap","background":"#1A2237","display":"flex","width":"100%","position":"relative","height":"100vh"}'>
		...
		<div :style='{"width":"100%","padding":"0px 20px 0","display":"flex","height":"calc(100vh - 0px)"}'>
			<div :style='{"width":"28%","padding":"30px 10px 0 0","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="yinyuexinxiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="yinyuexinxiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="yinyuexinxiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"44%","padding":"103px 30px 0","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231222/aa62a48dbb054747a476b05b66a6de6d.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20231222/aa62a48dbb054747a476b05b66a6de6d.png) no-repeat right top / auto 100%","justifyContent":"space-between","display":"flex"}'>
				<div v-if="systemIntroductionDetail" :style='{"padding":"0px","margin":"20px 0 20px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"calc(32% - 93px)"}'>
				...
				<!-- 统计 -->
				<div :style='{"alignContent":"flex-start","padding":"0px","margin":"0 0 20px","color":"#fff","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"center","height":"calc(32% - 40px)","order":"2"}'>
					...
					<div :style='{"margin":"0 20px 0 0 ","alignItems":"center","borderRadius":"100%","background":"rgba(255,255,255,.2)","flexDirection":"column","display":"flex","width":"130px","position":"relative","justifyContent":"center","height":"130px"}'>
						...
						<div :style='{"padding":"0","margin":"20px 0 0","alignItems":"center","textAlign":"center","flexDirection":"column","display":"block","justifyContent":"space-between"}'>
							<div :style='{"lineHeight":"auto","fontSize":"inherit","color":"inherit","height":"auto"}'>用户总数</div>
							<div :style='{"lineHeight":"40px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"auto"}'>{{yonghuCount}}</div>
						</div>
					</div>
					...
					<div :style='{"margin":"0 20px 0 0 ","alignItems":"center","borderRadius":"100%","background":"rgba(255,255,255,.2)","flexDirection":"column","display":"flex","width":"130px","position":"relative","justifyContent":"center","height":"130px"}'>
						...
						<div :style='{"padding":"0","margin":"10px 0 0","alignItems":"center","textAlign":"center","flexDirection":"column","display":"block","justifyContent":"space-between"}'>
							<div :style='{"lineHeight":"auto","fontSize":"inherit","color":"inherit","height":"auto"}'>音乐信息总数</div>
							<div :style='{"lineHeight":"auto","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"auto"}'>{{yinyuexinxiCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"padding":"0 0 0 60px","margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","width":"100%","lineHeight":"42px","fontSize":"16px","height":"42px"}'>音乐信息(播放数TOP10)</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"padding":"0","borderColor":"#044bbe","borderWidth":"1px 0 0 1px","background":"none","width":"100%","borderStyle":"solid","zIndex":"9"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="shoucang" label="收藏数"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="share" label="分享数"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="pinglun" label="评论数"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="bofang" label="播放数"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"28%","padding":"30px 0 0 10px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="yinyuexinxiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="yinyuexinxiChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
export default {
	data() {
		return {
			...
			bar: {"backgroundColor":"transparent","yAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":12,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#fff","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#ccc","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"minInterval":0,"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(250,250,250,0.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"xAxis":{"axisLabel":{"borderType":"solid","rotate":30,"padding":0,"shadowOffsetX":0,"margin":8,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#fff","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","interval":0,"fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":false},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(255,255,255,.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"color":["#2c99de","#28bbed","#60d3e3","#98dcb3","#ffd650","#ffa373","#ff7e91","#30dc75"],"legend":{"padding":[5,10,0,0],"itemGap":5,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"orient":"horizontal","shadowBlur":0,"bottom":"auto","itemHeight":12,"show":true,"icon":"roundRect","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"inherit","shadowOffsetY":0,"color":"inherit","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"transparent"},"right":"auto","top":"auto","borderRadius":0,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"inherit","shadowBlur":0,"width":"auto","type":"inherit","opacity":1,"shadowColor":"transparent"},"left":"right","borderWidth":0,"width":"auto","itemWidth":25,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","ellipsis":"...","overflow":"none","fontSize":12,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"transparent","textShadowBlur":0},"shadowColor":"rgba(0,0,0,.3)","height":"auto"},"grid":{"x":"15%","y":"15%","y2":"20%","x2":"5%"},"series":{"barWidth":"20px","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"#fff","shadowOffsetY":0,"color":"","shadowBlur":0,"borderWidth":0,"barBorderRadius":[20,20,0,0],"opacity":1,"shadowColor":"#000"},"colorBy":"data","barCategoryGap":"20%"},"tooltip":{"backgroundColor":"#fff","textStyle":{"color":"#333"}},"title":{"borderType":"solid","padding":[5,0,0,10],"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"shadowBlur":0,"bottom":"auto","show":false,"right":"auto","top":"0","borderRadius":0,"left":"left","borderWidth":0,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","fontSize":14,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"shadowColor":"transparent"},"base":{"animate":false,"interval":2000}},
			bar2: {"backgroundColor":"transparent","yAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":6,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#fff","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"150px","fontSize":12,"lineHeight":24,"interval":0,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#ccc","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(250,250,250,0.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"xAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":4,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#fff","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":false},"minInterval":1,"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(255,255,255,.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"color":["#2c99de","#28bbed","#60d3e3","#98dcb3","#ffd650","#ffa373","#ff7e91","#30dc75"],"legend":{"padding":[5,10,0,0],"itemGap":10,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"orient":"horizontal","shadowBlur":0,"bottom":"auto","itemHeight":14,"show":true,"icon":"roundRect","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"inherit","shadowOffsetY":0,"color":"inherit","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"transparent"},"right":"auto","top":"auto","borderRadius":0,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"inherit","shadowBlur":0,"width":"auto","type":"inherit","opacity":1,"shadowColor":"transparent"},"left":"right","borderWidth":0,"width":"auto","itemWidth":25,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","ellipsis":"...","overflow":"none","fontSize":12,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"transparent","textShadowBlur":0},"shadowColor":"rgba(0,0,0,.3)","height":"auto"},"grid":{"x":"15%","y":"15%","y2":"15%","x2":"5%"},"series":{"barWidth":"auto","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"#fff","shadowOffsetY":0,"color":"","shadowBlur":0,"borderWidth":0,"barBorderRadius":[0,20,20,0],"opacity":1,"shadowColor":"#000"},"colorBy":"data","barCategoryGap":"20%"},"tooltip":{"backgroundColor":"#fff","textStyle":{"color":"#333"}},"title":{"borderType":"solid","padding":2,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"shadowBlur":0,"bottom":"auto","show":false,"right":"auto","top":"auto","borderRadius":0,"left":"left","borderWidth":0,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","fontSize":14,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"shadowColor":"transparent"},"base":{"animate":false,"interval":2000}},
  ...
  created() {
    this.$nextTick(()=>{
		...
		setTimeout(()=>{
			this.getyonghuCount();
			this.getyinyuexinxiCount();
			this.yinyuexinxiChat1();
			this.yinyuexinxiChat2();
			this.yinyuexinxiChat3();
			this.yinyuexinxiChat4();
			this.yinyuexinxiChat5();
		},500)
	})
  },
  methods:{
    ...
    getyinyuexinxiCount() {
        this.$http({
            url: `yinyuexinxi/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.yinyuexinxiCount = data.data
            }
        })
    },
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'yinyuexinxiChart1');
...
//统计接口2
    yinyuexinxiChat2() {
      this.$nextTick(()=>{
        ...
        var yinyuexinxiChart2 = echarts.init(document.getElementById("yinyuexinxiChart2"),'macarons');
        this.$http({
            url: "yinyuexinxi/group/zuozhe",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                yinyuexinxiChart2.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    yinyuexinxiChart2.resize();
                },false);
            }
        });
      })
...
//统计接口3
    yinyuexinxiChat3() {
      this.$nextTick(()=>{
        ...
        var yinyuexinxiChart3 = echarts.init(document.getElementById("yinyuexinxiChart3"),'macarons');
        this.$http({
            url: `yinyuexinxi/value/zuozhe/shoucang`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                yinyuexinxiChart3.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    yinyuexinxiChart3.resize();
                },false);
            }
        });
      })
...
//统计接口4
    yinyuexinxiChat4() {
      this.$nextTick(()=>{
        ...
        var yinyuexinxiChart4 = echarts.init(document.getElementById("yinyuexinxiChart4"),'macarons');
        this.$http({
            url: `yinyuexinxi/value/zuozhe/bofang`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                yinyuexinxiChart4.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    yinyuexinxiChart4.resize();
				},false);
            }
        });
      })
...
//统计接口5
    yinyuexinxiChat5() {
      this.$nextTick(()=>{
        ...
        var yinyuexinxiChart5 = echarts.init(document.getElementById("yinyuexinxiChart5"),'macarons');
        this.$http({
            url: `yinyuexinxi/value/zuozhe/pinglun`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                yinyuexinxiChart5.setOption(option);


                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    yinyuexinxiChart5.resize();
					},false);
            }
        });
      })
